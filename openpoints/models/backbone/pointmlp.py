...
@MODELS.register_module()
class PointMLPPartSeg(nn.Module):
    def __init__(self, in_channels, num_classes=50,points=2048, embed_dim=64, groups=1, res_expansion=1.0,
        ...
        super(PointMLPPartSeg, self).__init__()
        self.stages = len(pre_blocks)
    ...
    def forward(self, p0, f0=None, cls0=None):
        ...
        cls_one_hot = torch.zeros((xyz.size(0), 16), device=xyz.device)
    ...
    def forward_seg_feat(self, p0, f0=None):
        return None, self.forward(p0, f0)
