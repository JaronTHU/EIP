...
def build_optimizer_from_cfg(
    ...
    Args:
        ...
        diff_lr: different learning rate for model [{'params': str, 'lr': float}], only test on pytorch optimizers
    ...
    if weight_decay and filter_bias_and_bn:
        ...
        weight_decay = 0.
    # INSERT: different learning rate
    elif diff_lr is not None:
        for d in diff_lr:
            d['params'] = eval(f'model.{d["params"]}.parameters()')
        parameters = diff_lr
    else:
